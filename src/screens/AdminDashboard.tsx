                  ...
                  status === 'approved' ? (
                    ...
                    <div className="flex gap-1">
                      <button
                        ...
                        className="text-[10px] px-2 py-1 bg-[#15572A] text-white rounded hover:bg-green-800 transition-colors"
                      >
                        Approve
                      </button>
                      <button
                        onClick={() => review(p.org)}
                        className="text-[10px] px-2 py-1 border border-zinc-300 rounded hover:border-zinc-500 text-zinc-600 transition-colors"
                      >
                        Review
                      </button>
                    </div>
