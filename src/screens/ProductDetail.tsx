              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    ...
                    className="flex flex-col gap-2 p-3 border border-zinc-200 rounded hover:border-zinc-300 transition-colors cursor-pointer"
                  >
                    ...
                    {openCert === i && (
                      <div className="text-xs text-zinc-500 bg-zinc-50 border border-zinc-200 rounded p-2">
