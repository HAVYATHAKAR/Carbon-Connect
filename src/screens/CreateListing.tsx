                    ...
                    {certs.map((c, i) => (
                      <div key={i} className="flex items-center justify-between">
                        ...
                        {c.uploaded
                          ...
                          : <button onClick={() => uploadCert(i)} className="text-xs px-3 py-1.5 border border-zinc-300 rounded hover:border-[#15572A] text-zinc-500 hover:text-[#15572A] transition-colors">Upload PDF</button>
                        }
                      </div>
                    ))}
                  </div>
